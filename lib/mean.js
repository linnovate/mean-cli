...
Meanio.prototype.serve = function() {
	require('./app/server');
};
...
Meanio.prototype.Module = function(name) {
	...
	// bootstrap models
	util.walk(modulePath(this.name) + '/server/models', null, function(path) {
		require(path);
	});
	...
	this.routes = function() {
		...
		var that = this;
		util.walk(modulePath(this.name) + '/server/routes', 'middlewares', function(path) {
