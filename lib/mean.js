...
Meanio.prototype.config = function() {
	...
	if (!database || !database.connection) {
		if (arguments.length === 2) return arguments[1](null, {});
		if (arguments.length === 1 && typeof arguments[0] === 'object') return arguments[0](null, {});
	}
	...
	if (arguments.length === 2) return updateSettings('config', arguments[0], arguments[1]);
	if (arguments.length === 1 && typeof arguments[0] === 'object') return updateSettings('config', arguments[0], function() {});
	if (arguments.length === 1 && typeof arguments[0] === 'function') return getSettings('config', arguments[0]);
