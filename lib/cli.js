...
var createPkgRepo = exports.createPkgRepo = function() {
    requiresPkgRoot(function(data) {
        request(config.meanApi.host + '/meanApi/packages/' + data.name, function(error, response, body) {
            if (error)
                console.log(error);
            else if (body.error)
            ...
            if (!body.error && !body.data) {
                console.log('package not exists, please login with mean login');
            }
        });
    });
}
    ...
    function requiresPkgRoot(callback) {
        loadPackageJson(process.cwd() + '/package.json', function(err, data) {
            ...
            // console.log(data);
            if (err || data.name == 'mean') {
                console.log('Invalid MEAN app or not in packages --package-- root');
            } else {
                callback(data);
            }
        });
