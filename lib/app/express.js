...
module.exports = function(app, db) {
    ...
    app.configure(function() {
        ...
        var assets = require(path.join(process.cwd(), 'assets/assets.json'));
        assetmanager.init({
            js: assets.js,
            css: assets.css,
        ...
        mean.events.on('modulesFound', function() {
            ...
            // Bootstrap models
            util.walk(process.cwd() + '/server/models', null, function(path) {
                require(path);
            });

            // Skip the app/routes/middlewares directory as it is meant to be used and 
            // shared by routes as further middlewares and is not a route itself
            util.walk(process.cwd() + '/server/routes', 'middlewares', function(path) {
                require(path)(app);
            });
